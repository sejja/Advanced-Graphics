...
namespace glm
{
	...
	struct type
	{
		...
		static length_t const mComponents = 0;
	...
	struct type<vec<L, T, Q> >
	{
		...
		static bool const is_mat = false;
		static bool const is_quat = false;
		static length_t const mComponents = L;
	};
	...
	struct type<mat<C, R, T, Q> >
	{
		...
		static bool const is_quat = false;
		static length_t const mComponents = C;
	...
	struct type<qua<T, Q> >
	{
		...
		static length_t const mComponents = 4;
	};
	...
	struct type<tdualquat<T, Q> >
	{
		...
		static bool const is_mat = false;
		static bool const is_quat = true;
		static length_t const mComponents = 8;
	};
