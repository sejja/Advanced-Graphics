...
namespace glm
{
	...
	template<typename T>
	length_t const type<T>::mComponents;
	template<typename T>
	...
	template<length_t L, typename T, qualifier Q>
	length_t const type<vec<L, T, Q> >::mComponents;
	...
	template<length_t C, length_t R, typename T, qualifier Q>
	length_t const type<mat<C, R, T, Q> >::mComponents;
	template<length_t C, length_t R, typename T, qualifier Q>
	...
	template<typename T, qualifier Q>
	length_t const type<qua<T, Q> >::mComponents;
	...
	template<typename T, qualifier Q>
	length_t const type<tdualquat<T, Q> >::mComponents;
}//namespace glm
